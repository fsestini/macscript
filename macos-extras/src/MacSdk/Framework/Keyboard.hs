module MacSdk.Framework.Keyboard
  ( Modifier(..)
  , ModifierPos(..)
  , Key(..)
  , ModifierPress
...
import MacSdk.Framework.CoreGraphics.Event
...
emToUInt32 EM_Fn       = fromIntegral eventFlagMaskSecondaryFn
...
type KeyCallback = KeyFlags -> CGKeyCode -> IO Bool
...
foreign import ccall "keycode_from_char" keycodeFromChar :: Char -> CGKeyCode

toKeycode :: Key -> CGKeyCode
